...
ColocalizeR <- function(x) {
  ...
  #ask user to select channels and fluorophores for analysis
  ...
  #define main loop for colocalization analysis
  colocmainloop <- function(i, meta = imgmeta) {
    require("rJava")
    require("devtools")
    require("EBImage")
    require("RBioFormats")
